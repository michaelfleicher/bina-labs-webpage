...
- **AEO (Answer Engine Optimization):** Getting AI engines (ChatGPT, Gemini, Codex, Perplexity) to use YOUR content as the answer to user questions. Measured by brand mentions in AI responses.
...
|--------|------------|----------|
| קהל | סורקי מנועים (Googlebot) | מודלי שפה (Codex/GPT/Perplexity) |
